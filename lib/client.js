		...
		*  the data URL when no object URL can be built. */
		...
		function adoptConfig(raw) {
			...
			cfg = {
				...
				rightbarOpacity: typeof c.rightbarOpacity === "number" && isFinite(c.rightbarOpacity) ? clamp01(c.rightbarOpacity, 1) : null
			};
				...
				children: PARTS.map((part, i) => {
					...
					return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
						...
						children: [
							...
							isRightbar ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
								className: "dab-hint",
								style: { marginTop: 9 },
								children: t("uiPreviewHint")
							}) : null
						]
					}, blurKey);
				})
