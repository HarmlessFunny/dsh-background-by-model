		...
		const HOST_CONTRACTS = [
			...
			},
			{
				...
				checks: [{
					...
					optionalWhen: "rightPanelMounted",
					visible: true
				}],
				sources: [{
			...
			},
			{
				...
				checks: [{
					kind: "selector",
					selector: "[data-dockkit-empty]",
					optionalWhen: "dockHasNoTab"
				}],
				sources: [{
					path: `${SIDEBAR_RIGHT}/lib/client.js`,
			...
			},
			{
				...
				checks: [{
					...
					optionalWhen: "trajectoryMounted"
				}],
				sources: [{
			...
			},
			{
				...
				checks: [{
					kind: "rule",
					match: "--dsw-alias-bg-base",
					hint: "platform palette"
				}, {
					kind: "computed",
			...
			},
			{
				...
				checks: [{
					kind: "rule",
					match: "--dsw-specific-sidebar-fill",
					hint: "sidebar fill"
				}, {
					kind: "computed",
			...
			},
			{
				...
				checks: [{
					kind: "rule",
					match: "--dsw-specific-input-major",
					hint: "input/control fill"
				}, {
					kind: "computed",
